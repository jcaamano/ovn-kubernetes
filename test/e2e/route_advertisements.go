...
func (t networkType) needsBGP() bool {
	switch t {
	case cudnAdvertised, cudnAdvertisedVRFLite, cudnAdvertisedEVPNUnmanagedSharedVTEP, cudnAdvertisedEVPNUnmanagedRandomVTEP:
		return true
	default:
		return false
	}
...
func createNamespaceWithPrimaryNetworkOfType(
	...
	if isAdvertised {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to create RouteAdvertisements: %w", err)
		}
	}
